...
void do_output()
{
    ...
    for (int x = 0; x < jpg.height; x++) {
        for (int y = 0; y < jpg.width; y++) {
            double Y = jpg.bmp_YCbCr[0][x][y],
                   Cb = jpg.bmp_YCbCr[1][MIN(x/scale_Cb_x, jpg.comp[1].height-1)][MIN(y/scale_Cb_y, jpg.comp[1].width-1)],
                   Cr = jpg.bmp_YCbCr[2][MIN(x/scale_Cr_x, jpg.comp[1].height-1)][MIN(y/scale_Cr_y, jpg.comp[2].width-1)];
    ...
    for (int x = 0; x < jpg.height; x++) {
        for (int y = 0; y < jpg.width; y++) {
            rgb_pixel_t pixel = {jpg.bmp_RGB[2][x][y], jpg.bmp_RGB[1][x][y], jpg.bmp_RGB[0][x][y]};
